...
public class TotalMoneyCartControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(" <li class=\"d-flex justify-content-between py-3 border-bottom\"><strong class=\"text-muted\">Total amount you have to pay</strong><strong>" + totalMoney + "</strong></li>\r\n"
