    ...
    <body>
        <jsp:include page="Menu1.jsp"></jsp:include>
            <div id="logreg-forms">
                ...
                <input name="password" type="repassword" id="password" class="form-control" value="" required="" autofocus="">
                <label for="password">RePassword</label>             
                <input name="repassword" type="repassword" id="password" class="form-control" value="" required="" autofocus="">
                <label for="email">Email</label>
                <input name="email" type="text" id="email" class="form-control" value="" required="" autofocus="">
