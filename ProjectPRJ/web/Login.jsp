...
<html lang="en">
    ...
    <body>
        <jsp:include page="Menu1.jsp"></jsp:include>
            ...
            <input name="pass" value="${password}" type="password" id="inputPassword" class="form-control" placeholder="Password" required=""><button type="button" id="showPasswordButton" style="border-color: white" >show
</button>
