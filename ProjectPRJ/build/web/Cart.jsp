...
<html>
    ...
    <body onload="loadTotalMoney()">
                ...
                <div class="px-4 px-lg-0">
                    ...
                    <div class="pb-5">
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-6">
                                <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Prepare invoices</div>
                                ...
                                <div class="p-4">
                                    ...
                                    </ul><a href="order" class="btn btn-dark rounded-pill py-2 btn-block text-white">PrePare to Pay</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function loadTotalMoney() {
            $.ajax({
                url: "/ProjectSE1762_HE170538/totalMoneyCart",
